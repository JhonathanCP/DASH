...
SELECT A.ATENAMBORICENASICOD AS ORIGEN,
 ...
 WHERE TRUNC(A.ATENAMBATENFEC) BETWEEN TO_DATE('01/09/2024', 'DD/MM/YYYY') AND --AQUI CAMBIAR LA FECHA
       TO_DATE('30/09/2024', 'DD/MM/YYYY') --AQUI CAMBIAR LA FECHA
...
SELECT B.ATENOMORICENASICOD AS ORIGEN,
 ...
 WHERE B.ATENOMFEC BETWEEN TO_DATE('01/09/2024', 'DD/MM/YYYY') AND --AQUI CAMBIAR LA FECHA
       TO_DATE('30/09/2024', 'DD/MM/YYYY') --AQUI CAMBIAR LA FECHA
...
SELECT CT.CITAMBORICENASICOD AS ORIGEN,
 ...
 WHERE CT.CITAMBPROCONFEC BETWEEN TO_DATE('01/09/2024', 'DD/MM/YYYY') AND --AQUI CAMBIAR LA FECHA
       TO_DATE('30/09/2024', 'DD/MM/YYYY') --AQUI CAMBIAR LA FECHA
